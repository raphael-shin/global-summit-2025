...
class GfpganCodeBuildStatusCheckerStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, codebuild_projects: list, **kwargs) -> None:
        ...
        status_checker_lambda = lambda_.Function(self, "GfpganCodeBuildStatusChecker",
            runtime=lambda_.Runtime.PYTHON_3_9,
            handler="index.handler",
            code=lambda_.Code.from_asset("lambda/gfpgan_codebuild_status_checker"),
        ...
        custom_resource = CustomResource(self, "GfpganCodeBuildStatusResource",
            service_token=cr.Provider(self, "GfpganCodeBuildStatusProvider",
